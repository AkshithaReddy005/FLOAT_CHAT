...
DEPTH_PATTERNS = [
    ...
    (r"depth\s+is\s+more\s+than\s*(\d+)", ">=", "operator"),
    (r"depths?\s+is\s+more\s+than\s*(\d+)", ">=", "operator"),
    (r"depths?\s+are\s+more\s+than\s*(\d+)", ">=", "operator"),
    (r"depth\s+is\s+greater\s+than\s*(\d+)", ">=", "operator"),
    (r"depths?\s+is\s+greater\s+than\s*(\d+)", ">=", "operator"),
    (r"depths?\s+are\s+greater\s+than\s*(\d+)", ">=", "operator"),
    (r"depth\s+is\s+less\s+than\s*(\d+)", "<=", "operator"),
    (r"depths?\s+is\s+less\s+than\s*(\d+)", "<=", "operator"),
    (r"depths?\s+are\s+less\s+than\s*(\d+)", "<=", "operator"),
    (r"depth\s+is\s+below\s*(\d+)", ">=", "operator"),
    (r"depths?\s+is\s+below\s*(\d+)", ">=", "operator"),
    (r"depths?\s+are\s+below\s*(\d+)", ">=", "operator"),
    (r"depth\s+is\s+above\s*(\d+)", "<=", "operator"),
    (r"depths?\s+is\s+above\s*(\d+)", "<=", "operator"),
    (r"depths?\s+are\s+above\s*(\d+)", "<=", "operator"),
    (r"at\s*(\d+)\s*m", None, "exact"),
    (r"at\s*depth\s*(\d+)\s*m", None, "exact"),
    (r"depth\s*(\d+)", None, "range"),
    (r"(\d+)\s*m\s*deep", None, "range"),
]
